...
ICAL.Event = (function() {
  ...
  Event.prototype = {
    ...
    get organizer() {
      ...
      //return this._toReadable('organizer');
      return this._allProp('organizer');
    },
    ...
    _allProp: function(name) {
      return this.component.getAllProperties(name);
    },

    // _toReadable: function(name) {
    //   return this.component.getReadablePropertyValues(name);
    // },
